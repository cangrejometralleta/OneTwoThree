...
- Two bolds in a paragraph Cancel each other.  
  So do two shouts.

The tiers Stack, so read them as one scale:  
lowercase Carries the sentence,  
a capital Raises the word that turns it,  
and bold Stops the reader on the line the section was written for.

## Code Keeps its own Rule
