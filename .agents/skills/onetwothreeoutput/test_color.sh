...
'onetwothreecase Carries onetwothreerefactor
onetwothreerefactor has no Slug
~/.claude/skills/onetwothreecase -> .agents/skills/onetwothreerefactor
onetwothreeoutput is fine'
