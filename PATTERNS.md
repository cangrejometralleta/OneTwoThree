...
- So Trust is Distributed across many Nodes,
  never Granted to one Voice.
- A Commit SHA is an addressable Point of Trust.
- You Trust verified States,
  and Preserve the Delta that Explains them.
- Code is one Part of a Product,
...
- A Human Writes to the Breath,
  and Stops where the Thought Stops,
  which is rarely the same Place twice.
- Balance is not Rhythm.
  Balance is what Rhythm Looks like
  when nobody Felt it.
- We Measured this Repository.
  The flattest Sections were the Generated ones.
- Measure your own Text.
  The flattest Passage is the one you Assembled
  instead of Hearing.
...
- Let it in through one Door,
  ...
  not the Vendor's.
- Name the Door for what you Need,
  never for who Fills it.
- Count the Files that Import a Guest.
  One is Discipline. Ten is a Marriage.
- The Literature Calls the Door a Port,
  the Guest an Adapter.
  We Call the Guest a Provider, which Collides,
...
- Most of it is Noise,
  a Few of the small Madnesses are a Door.
- Cage Kept whatever Chance Gave,
  you Keep only the Doors.
- The System Generates, the Human Selects.
- Roll the Dice inside a Rule,
  and the Outcome is still Yours.
